...
// Función asíncrona para obtener la información de la API y llamar a la función indexInitializer()
          ...
          <div class="col">
            <div class="card h-100 p-3">
              ...
              <div class="card-footer d-inline-flex justify-content-around">
                ...
                <a href="./pages/details.html?id=${event._id}" class="btn text-white">More Info</a>
              </div>
            </div>
          </div>
          `;
