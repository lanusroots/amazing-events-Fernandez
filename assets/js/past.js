...
const currentDate = arrayEvents.currentDate;
const containerCards = document.getElementById("cardEvent");
...
function createNewCards(data) {
  ...
  for (const item of data.events) {
    if (currentDate > item.date){
      ...
      <img src="${item.image}" class="card-img-top" alt="Cinema">
      <div class="card-body">
      ...
      <span><i class="bi bi-tags"></i> Price: $${item.price}</span>
      </div>
      <a href="./details.html" class="btn text-white">More Info</a>
      </div>
      </div>
      </div>
      `;
...
let cards = createNewCards(arrayEvents);
